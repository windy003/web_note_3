    ...
    <>
        ...
        <div className="register-container">
          <div className="register-form-wrapper">
            <div className="register-header">
              ...
              <p className="register-subtitle">加入我们，开始记录您的精彩时刻</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="register-form">
              ...
              <div className="form-group">
                <div className="input-wrapper">
                  ...
                  <input type="text" className="form-input" placeholder=" " value={username} onChange={e => setUsername(e.target.value)} required minLength={4} maxLength={20} />
              ...
              <div className="form-group">
                <div className="input-wrapper">
                  ...
                  <input type="password" className="form-input" placeholder=" " value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required minLength={6} />
            ...
            <div className="auth-links">
              <p>已有账号？<Link href="/login" className="login-link">点击登录</Link></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .register-form-wrapper {
          ...
          padding: 3rem 2.5rem; box-shadow: 0 20px 40px rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.2);
        }
        ...
        .register-icon {
          ...
          border-radius: 20px; color: white; margin-bottom: 1.5rem; box-shadow: 0 10px 20px rgba(102,126,234,0.3);
        }
        .register-title { font-size: 2rem; font-weight: 700; color: #2d3748; margin: 0 0 0.5rem 0; }
        .register-subtitle { color: #718096; font-size: 1rem; margin: 0; }
        .form-group { margin-bottom: 1.5rem; }
        .input-wrapper { position: relative; }
        .input-icon { position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #a0aec0; z-index: 2; }
        .form-input {
          width: 100%; padding: 1rem 1rem 1rem 3rem; border: 2px solid #e2e8f0; border-radius: 12px;
          background-color: #f7fafc; font-size: 1rem; transition: all 0.3s ease; box-sizing: border-box;
        }
        ...
        .register-btn {
          ...
          box-shadow: 0 4px 15px rgba(102,126,234,0.4); margin-top: 2rem;
        }
        .register-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(102,126,234,0.6); }
        ...
        @media (max-width: 480px) {
          .register-page { padding: 1rem; min-height: calc(100vh - 80px); }
          .register-form-wrapper { padding: 2rem 1.5rem; border-radius: 16px; }
          .register-title { font-size: 1.75rem; }
          .register-icon { width: 60px; height: 60px; border-radius: 16px; }
        }
      `}</style>
    </>
  );
